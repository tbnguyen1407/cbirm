...
public class ColorCoherenceVector
{
    ...
    {
        int[][][] dctMatrix = (new DCT(image)).DCTmatrix;
    ...
    {
        String indexStr = ImageIndexHolder.getInstance().loadImageIndex(ImageIndexHolder.FeatureType.ColorCoherenceVector, image);
    ...
    {
        ImageIndexHolder.getInstance().saveImageIndex(ImageIndexHolder.FeatureType.ColorCoherenceVector, image, indexToString(index));
    }

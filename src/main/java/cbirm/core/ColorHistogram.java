...
public class ColorHistogram {
    ...
    public static double ColorSim(int i, int j) {
        ...
        double diff = Math
                .sqrt((double) Math.pow((nyi - nyj), 2) + Math.pow((nui - nuj), 2) + Math.pow((nvi - nvj), 2));
        String s = " ";
    ...
    public static int[] loadImageIndex(String image) {
        String indexStr = ImageIndexHolder.getInstance().loadImageIndex(ImageIndexHolder.FeatureType.ColorHistogram,
                image);
        int[] indexIntArray;
    ...
    public static void saveImageIndex(String image, int[] index) {
        ImageIndexHolder.getInstance().saveImageIndex(ImageIndexHolder.FeatureType.ColorHistogram, image,
                indexToString(index));
    }

    public static int[] createIndex(String image) {
        return ColorHistogram.GetYUVHist((new DCT(image)).getMatrix());
    }
